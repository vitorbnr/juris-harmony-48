...
function ProcessoDrawer({ processo, onClose }: { processo: Processo; onClose: () => void }) {
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { label: "Distribuição", value: new Date(processo.dataDistribuicao).toLocaleDateString("pt-BR") },
            ...
            {processo.proximoPrazo && (
              <div className="flex items-center gap-3 rounded-lg bg-destructive/10 border border-destructive/20 px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground">{new Date(processo.proximoPrazo).toLocaleDateString("pt-BR")}</p>
                </div>
              </div>
            )}
          </div>
              ...
              <div className="relative space-y-0">
                {processo.movimentacoes.map((mov, i) => (
                  <div key={mov.id} className="flex gap-3">
                    ...
                    <div className="pb-4">
                      <p className="text-[10px] text-muted-foreground">{new Date(mov.data).toLocaleDateString("pt-BR")}</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/30">
                ...
                <th className="text-left px-5 py-3 text-muted-foreground font-medium text-xs tracking-wide hidden lg:table-cell">Próximo Prazo</th>
                ...
                return (
                  ...
                  >
                    <td className="px-5 py-4">
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="inline-flex items-center gap-1 text-[10px] text-muted-foreground">
                          <MapPin className="h-2.5 w-2.5" />{p.unidadeNome ?? p.unidadeId}
                        </span>
                      </div>
                    </td>
                    <td className="px-5 py-4">
                    ...
                    <td className="px-5 py-4 hidden lg:table-cell">
                      {p.proximoPrazo ? (
                        <span className="text-sm text-muted-foreground">{new Date(p.proximoPrazo).toLocaleDateString("pt-BR")}</span>
